...
const Main = () => {
  return (
    <div className="font-mono w-full bg-slate-100">
      ...
      <div className="flex">
        ...
        <div className="bg-white rounded-md w-full m-4">
          <div className="text-sm font-medium text-center text-gray-500 border-b-2 border-gray-200">
            <ul className="flex justify-around -mb-px ms-6">
              <li className="w-full text-start">
                <a
                  href="#"
                  className="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 font-medium"
                >
                  About
                </a>
              </li>
          ...
          <div>
              ...
              <div>
                <p>
                  ...
                  content and they approved it and today i tried to upload they
                  say we no longer acept it
                </p>
                <div className="w-full h-64 bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-md" />
                  ...
                  <div>
                    ...
                    <div className="ms-12">
                      ...
                      <div className="ms-12">
                        ...
                        <button className="font-semibold ms-12 my-4">Load more comments</button>
                      </div>
                    </div>
                  </div>
                </div>
